...
- Team size (DERIVED, not a published figure): the About page lists 3 doctor bios and 12 additional staff bios; 3 + 12 = 15 people total is arithmetic performed over that roster, not a headcount the practice states about itself anywhere in the evidence (source: https://www.cfdentistrysnohomish.com/about-us, captured 2026-07-22)
...
- New Patient Exam and Emergency Exam are priced only on the practice-wide price list page, not on this dedicated page: "New Patient Exam, Cleaning, and imaging: $456" and "Emergency Exam: $125" — there is no dedicated new-patient or emergency page (source: https://www.cfdentistrysnohomish.com/services-and-pricing, captured 2026-07-22)
...
- The practice-wide price list page also lists "Custom Bleach Trays: $350" — same figure as "Custom Trays: $350" above, different label, no separate page (source: https://www.cfdentistrysnohomish.com/services-and-pricing, captured 2026-07-22)
...
- Page H1 on both source pages: "Botox and Fillers"; the `/botox` page adds the subhead "Taking Care of You" (source: https://www.cfdentistrysnohomish.com/blank-page-1 and https://www.cfdentistrysnohomish.com/botox, captured 2026-07-22)
...
- Only page A states that both medical and cosmetic botox are offered; only page B states the dental-and-facial-wellness framing and carries pricing — a merged section needs both (source: https://www.cfdentistrysnohomish.com/blank-page-1 and https://www.cfdentistrysnohomish.com/botox, captured 2026-07-22)
...
- Page H1 on both source pages: "Sleep Apnea"; page A (`/blank-page`) adds the line "Do you think you have Sleep Apnea?" and the H2 "Sleep Apnea Screening in Our Office"; page B (`/copy-of-fillings-and-crowns-1`) adds the subhead "Helping You Sleep Better" (source: https://www.cfdentistrysnohomish.com/blank-page and https://www.cfdentistrysnohomish.com/copy-of-fillings-and-crowns-1, captured 2026-07-22)
...
- Only page A describes the in-exam screening protocol (small-airway checks, follow-up questions, at-home study candidacy, in-office appliance fabrication) and the "cheaper and more comfortable than an in lab sleep study" claim; only page B carries pricing and the CPAP-alternative framing — a merged section needs both (source: https://www.cfdentistrysnohomish.com/blank-page and https://www.cfdentistrysnohomish.com/copy-of-fillings-and-crowns-1, captured 2026-07-22)
...
- Cherry — Type of Financing: "“Buy Now, Pay Later” plan" (curly double quotes in source, reproduced verbatim) (source: https://www.cfdentistrysnohomish.com/financing, captured 2026-07-22)
...
and Tiffany transcriptions were independently reverified against their
full-resolution source images by the project lead during this build session
(2026-07-22), after the initial capture — this is why `reviews-rendered.md`,
which reflects the state at capture time, names only Kay as verified; Tiffany's
image was confirmed during the same 2026-07-22 session (including the "with
with regards" duplication, verbatim). The remaining ten were transcribed the
same way at capture time.
